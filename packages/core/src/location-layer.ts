...
import { PhaseVerification } from "./session/runner/phase-verification"
...
export class LocationServiceMap extends LayerMap.Service<LocationServiceMap>()("@opencode/example/LocationServiceMap", {
  lookup: (ref: Location.Ref) => {
    ...
    const phaseVerification = PhaseVerification.layer.pipe(Layer.provide(services), Layer.provide(todos))
